                        ...
                        <div className="hidden lg:col-span-5 bg-black/20 p-8 md:p-12 md:flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-brand-secondary/5 relative overflow-hidden">
                            ...
                            <div className="flex flex-col gap-6 mt-12 relative z-10 border-t border-brand-secondary/5 pt-8">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <a href="idealdesign.studio12@gmail.com" className="text-brand-secondary hover:text-brand-tertiary font-sans text-sm md:text-base transition-colors duration-200">
                                                ...
                                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                                    {services.map((s) => (
                                                        <button
                                                            ...
                                                            className={`py-2.5 px-3 border text-[10px] md:text-xs font-bold tracking-widest uppercase transition-all duration-200 cursor-pointer ${selectedServices.includes(s)
